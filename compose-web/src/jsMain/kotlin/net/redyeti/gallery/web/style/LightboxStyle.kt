...
object LightboxStyle : StyleSheet() {
  ...
  val fullscreen by style {
    ...
    backgroundImage("url(\"data:image/svg+xml,%3Csvg width='40px' height='40px' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg%3E%3Cpath fill='%23FFFFFF' opacity='0.5' d='M7 2H2v5l1.8-1.8L6.5 8 8 6.5 5.2 3.8 7 2zm6 0l1.8 1.8L12 6.5 13.5 8l2.7-2.7L18 7V2h-5zm.5 10L12 13.5l2.7 2.7L13 18h5v-5l-1.8 1.8-2.7-2.8zm-7 0l-2.7 2.7L2 13v5h5l-1.8-1.8L8 13.5 6.5 12z'/%3E%3C/g%3E%3C/svg%3E")
    position(Position.Absolute)
    right(0.px)
    bottom(40.px)
    width(40.px)
